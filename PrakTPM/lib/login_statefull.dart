...
class loginStful extends StatefulWidget {
  loginStful({Key? key}) : super(key: key);

  @override
  _loginStfulState createState() => _loginStfulState();
}

class _loginStfulState extends State<loginStful> {
  String username = "";
  String password = "";
